...
bool AaShaderCompiler::reflectShaderInfo(IDxcResult* compiledShaderBuffer, ShaderDescription& description, ShaderType type)
{
...
public:
	...
	HRESULT STDMETHODCALLTYPE LoadSource(_In_ LPCWSTR pFilename, _COM_Outptr_result_maybenull_ IDxcBlob** ppIncludeSource) override
	{
		...
		auto fullpath = std::wstring(SHADER_HLSL_DIRECTORY.begin(), SHADER_HLSL_DIRECTORY.end()) + pFilename;
...
ComPtr<IDxcBlob> AaShaderCompiler::compileShader(const ShaderRef& ref, ShaderDescription& description, ShaderType type)
{
