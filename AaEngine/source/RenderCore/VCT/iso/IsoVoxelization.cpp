...
void IsoVoxelization::initialize(RenderSystem& renderSystem, const FrameParameters& params, GraphicsResources& resources, ShadowMaps& shadows, RenderWorld& mgr, DXGI_FORMAT outputFormat)
{
	shadowMaps = &shadows;
	renderWorld = &mgr;
	frameParams = &params;
