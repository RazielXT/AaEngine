...
AaRenderSystem::AaRenderSystem(AaWindow* mWindow)
{
	...
	backbuffer.InitExisting(swapChainTextures, device, width, height, FrameCount);
...
AaRenderSystem::CommandsData AaRenderSystem::CreateCommandList()
{
	CommandsData data;
...
void AaRenderSystem::StartCommandList(AaRenderSystem::CommandsData commands)
{
...
void AaRenderSystem::ExecuteCommandList(AaRenderSystem::CommandsData commands)
{
