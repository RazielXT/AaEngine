...
struct IsoSeparateVoxelCascade
{
	...
	void prepareForVoxelization(ID3D12GraphicsCommandList* commandList, TextureStatePair& voxelScene, TextureStatePair& prevVoxelScene, TextureStatePair& voxelOccupancy, TextureStatePair& prevVoxelOccupancy, const GpuTexture3D& clearColor, const GpuTexture3D& clearOccupancy, ClearBufferComputeShader&);
